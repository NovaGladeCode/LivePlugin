...
public class LiveCommand implements CommandExecutor {
    ...
    private void sendHelp(Player p) {
        ...
        p.sendMessage("§e/mace give nether §7- Get a Nether Mace (OP only)");
        p.sendMessage("§e/wardenmace 1 §7- Sculk Resonance (5min cooldown)");
        p.sendMessage("§e/wardenmace 2 §7- Sonic Shockwave (4min cooldown)");
        p.sendMessage("§e/nethermace 1 §7- Infernal Wrath (4min cooldown)");
        p.sendMessage("§e/nethermace 2 §7- Fire Tornado (6min cooldown)");
